...
def create_shp_file_shri(zoom=None):
    states = gpd.read_file(
        # "/s/parsons/b/others/sustain/varsh/Python/GOES/cb_2018_us_state_500k/cb_2018_us_state_500k.shp"
        "/s/parsons/b/others/sustain/varsh/Python/GOES/cb_2018_us_state_500k/cb_2018_us_state_500k.shp"
    )
...
if __name__ == "__main__":
    ...
    # nm = gpd.read_file('/s/parsons/b/others/sustain/varsh/Python/GOES/states_quads/quadshape_9_New_Mexico/quadhash.shp')
    # print(nm.head())
