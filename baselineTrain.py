...
def save_checkpoint(model, optimizer, epoch, train_losses, test_losses, filename="preTrainedViTBaseline.pth"):
...
def load_checkpoint(model, optimizer, filename="preTrainedViTBaseline.pth"):
...
def train_model(model, train_dataloader, test_dataloader, num_epochs, learning_rate, mask_threshold = 0.9, checkpoint_path="preTrainedViTBaseline.pth"):
    model.to(device)
